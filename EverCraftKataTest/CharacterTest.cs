...
namespace EverCraftKataTest
{
    public class CharacterTest
    {
        ...
        [TestCase(EnumAlignment.Good)]
        [TestCase(EnumAlignment.Evil)]
        [TestCase(EnumAlignment.Neutral)]
        public void ItHasAValidAlignmentOf(EnumAlignment alignment)
        {
